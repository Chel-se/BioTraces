...
@InputType()
class PassportDetailCreateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => TravelDetailCreateNestedManyWithoutPassportDetailsInput,
  })
  @ValidateNested()
  @Type(() => TravelDetailCreateNestedManyWithoutPassportDetailsInput)
  @IsOptional()
  @Field(() => TravelDetailCreateNestedManyWithoutPassportDetailsInput, {
    nullable: true,
  })
  travelDetails?: TravelDetailCreateNestedManyWithoutPassportDetailsInput;
}

export { PassportDetailCreateInput as PassportDetailCreateInput };
