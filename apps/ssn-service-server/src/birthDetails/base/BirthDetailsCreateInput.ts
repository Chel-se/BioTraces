...
@InputType()
class BirthDetailsCreateInput {
  @ApiProperty({
    required: false,
    type: () => EducationRecordCreateNestedManyWithoutBirthDetailsItemsInput,
  })
  @ValidateNested()
  @Type(() => EducationRecordCreateNestedManyWithoutBirthDetailsItemsInput)
  @IsOptional()
  @Field(() => EducationRecordCreateNestedManyWithoutBirthDetailsItemsInput, {
    nullable: true,
  })
...
export { BirthDetailsCreateInput as BirthDetailsCreateInput };
