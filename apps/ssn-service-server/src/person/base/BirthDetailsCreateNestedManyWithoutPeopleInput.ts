...
@InputType()
class BirthDetailsCreateNestedManyWithoutPeopleInput {
...
export { BirthDetailsCreateNestedManyWithoutPeopleInput as BirthDetailsCreateNestedManyWithoutPeopleInput };
