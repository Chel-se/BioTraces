...
@InputType()
class BirthDetailsUpdateManyWithoutHealthRecordsInput {
...
export { BirthDetailsUpdateManyWithoutHealthRecordsInput as BirthDetailsUpdateManyWithoutHealthRecordsInput };
