...
@InputType()
class BirthDetailsCreateNestedManyWithoutHealthRecordsInput {
...
export { BirthDetailsCreateNestedManyWithoutHealthRecordsInput as BirthDetailsCreateNestedManyWithoutHealthRecordsInput };
