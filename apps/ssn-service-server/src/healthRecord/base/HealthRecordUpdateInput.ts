...
@InputType()
class HealthRecordUpdateInput {
  @ApiProperty({
    required: false,
    type: () => BirthDetailsUpdateManyWithoutHealthRecordsInput,
  })
  @ValidateNested()
  @Type(() => BirthDetailsUpdateManyWithoutHealthRecordsInput)
  @IsOptional()
  @Field(() => BirthDetailsUpdateManyWithoutHealthRecordsInput, {
    nullable: true,
  })
...
export { HealthRecordUpdateInput as HealthRecordUpdateInput };
